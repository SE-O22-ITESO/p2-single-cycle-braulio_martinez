...
add wave -noupdate -group ALU -color Red /RV32I_tb/dut/core/alu/cond_jump
add wave -noupdate -group ALU -color Red /RV32I_tb/dut/core/alu_a
add wave -noupdate -group ALU -color Red /RV32I_tb/dut/core/alu_b
add wave -noupdate -group ALU -color Red /RV32I_tb/dut/core/alu_out
add wave -noupdate -group ALU -color Red /RV32I_tb/dut/core/alu_out_s3
add wave -noupdate -group ALU -color Red /RV32I_tb/dut/core/alu/adder_substracter/a
add wave -noupdate -group ALU -color Red /RV32I_tb/dut/core/alu/adder_substracter/b
add wave -noupdate -group ALU -color Red /RV32I_tb/dut/core/alu/adder_substracter/mode
add wave -noupdate -group ALU -color Red /RV32I_tb/dut/core/alu/adder_substracter/result
...
WaveRestoreCursors {{Cursor 1} {114429761 ps} 0} {{Cursor 2} {59758 ps} 0}
...
update
WaveRestoreZoom {114359730 ps} {114462270 ps}
